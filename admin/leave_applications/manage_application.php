...
<!-- 					<div class="form-group">
				    	...
				    	<form action="" id="update-option1-form">
				            ...
				            <div class="form-group">
				                ...
				                <select id="option1" name="option1" class="form-control rounded-0">
				                    ...
				                    <option value="1" <?php echo (isset($option1) && $option1 ==1)?'selected' : '' ?>>Within the Philippines</option>
	...
	<div class="card-footer">
		<button class="btn btn-sm btn-primary" form="leave_application-form">Save</button>
		<a class="btn btn-sm btn-danger" href="?page=leave_applications">Cancel</a>
	</div>
</div>
<script>
