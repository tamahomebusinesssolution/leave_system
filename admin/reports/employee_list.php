    ...
    <div class="row">
        <div class="col-3">
            <div class="form-group">
                <!-- <select name="position_id" id="position_id" class="form-control select2bs4 rounded-0" >
        ...
        <div class="col-2 row align-items-end pb-1">      
            <div class="form-group d-flex justify-content-between align-middle">
                <button class="btn btn-sm btn-default bg-lightblue" type="button" id="filter"><i class="fa fa-filter"></i> Position</button>
            </div>
        </div>
    </div>        
    <?php
...
?>
                        <tr>
                            ...
                            <!-- <td><?php echo isset($pos_arr[$row['position_id']]) ? $pos_arr[$row['position_id']] : 'N/A' ?></td> -->
