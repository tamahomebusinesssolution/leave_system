...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Credit Leave Reports</h3>
...
<script>
	$(document).ready(function(){
        $('#filter').click(function(){
            location.replace("./?page=reports/credit_leave_report&date_start="+($('#date_start').val())+"&date_end="+($('#date_end').val()));
        })
        ...
        $('#print').click(function(){
            ...
            '<h3 class="text-center">Credit Leave Reports</h3>'+
