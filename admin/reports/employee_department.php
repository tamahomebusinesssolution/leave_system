...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h3 class="card-title">List of Employee per Department</h3>
    </div>
    <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-2 row align-items-end pb-1">      
                            <div class="form-group d-flex justify-content-between align-middle">
                                <button class="btn btn-sm btn-default bg-lightblue" type="button" id="filter"><i class="fa fa-filter"></i> Department</button>
                            </div>
                        </div>  
                    </div>          
                        <?php
...
<script>
    $(document).ready(function(){
        $('#filter').click(function(){
            location.replace("./?page=reports/employee_department&department_id="+($('#department_id').val()));
        })
        $('.table').dataTable();
    })
    $(function(){
